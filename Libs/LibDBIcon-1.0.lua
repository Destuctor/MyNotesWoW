...
local atan2 = math.atan2 or math.atan -- math.atan2 was removed; math.atan(y, x) is its replacement
...
local function onUpdate(self)
	...
	if self.db then
		self.db.minimapPos = math.deg(atan2(py - my, px - mx)) % 360
	else
		self.minimapPos = math.deg(atan2(py - my, px - mx)) % 360
	end
	updatePosition(self)
end
